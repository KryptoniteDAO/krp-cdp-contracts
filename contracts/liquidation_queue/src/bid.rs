...
use bigint::U256;
use cdp::oracle_pyth::PriceResponse;
use cdp::querier::{query_price, query_collateral_whitelist_info};
...
/// Control executes the liquidation providing a whitelisted collateral.
